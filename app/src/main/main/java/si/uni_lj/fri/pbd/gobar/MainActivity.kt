...
class MainActivity : AppCompatActivity(), CompendiumFragment.detailsLst {
    ...
    private var mapsActive :Boolean = false
    private var compendiumActive :Boolean = false
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("MAINACTIVITY", detailsList!!.size.toString())
